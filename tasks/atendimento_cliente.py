    ...
    for atendimento in atendimentos:
        ...
        try:
            ...
            db.executarQuery(
                ...
                f"(1, {atendimento['id_atendimento']}, {atendimento['fk_cliente']}, null, null, 1, DEFAULT, NOW(), 'Sucesso ao enviar e-mail de atendimento para o usuário {atendimento['fk_usuario']}')"
            )
            ...
            db.executarQuery(
                "INSERT INTO log_envio_lembrete (fk_tipo_lembrete, fk_atendimento, fk_cliente, fk_conta, fk_nota_fiscal, funcionou, id_log_envio_lembrete, data_hora_criacao, mensagem) VALUES "
                f"(1, {atendimento['id_atendimento']}, {atendimento['fk_cliente']}, null, null, 0, DEFAULT, NOW(), 'Falha ao enviar e-mail de atendimento: {erro_sql}')"
            )